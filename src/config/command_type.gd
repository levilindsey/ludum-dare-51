...
#    BUILDING_FARM_MEDIUM_UPGRADE: Cost.BUILDING_FARM_MEDIUM_UPGRADE,
    ...
    FRIENDLY_SMALL_WORKER: 0,
    FRIENDLY_MEDIUM_WORKER: 0,
    FRIENDLY_LARGE_WORKER: 0,
...
const ENTITY_NAMES := {
    ...
    FRIENDLY_SMALL_WORKER: Description.ENTITY_NAMES.FRIENDLY_SMALL_WORKER,
    FRIENDLY_MEDIUM_WORKER: Description.ENTITY_NAMES.FRIENDLY_MEDIUM_WORKER,
    FRIENDLY_LARGE_WORKER: Description.ENTITY_NAMES.FRIENDLY_LARGE_WORKER,
...
const ENTITY_DESCRIPTIONS := {
    ...
    FRIENDLY_SMALL_WORKER: Description.ENTITY_DESCRIPTIONS.FRIENDLY_SMALL_WORKER,
    FRIENDLY_MEDIUM_WORKER: Description.ENTITY_DESCRIPTIONS.FRIENDLY_MEDIUM_WORKER,
    FRIENDLY_LARGE_WORKER: Description.ENTITY_DESCRIPTIONS.FRIENDLY_LARGE_WORKER,
...
#
#    FRIENDLY_SMALL_WORKER: Description.COMMAND_LABELS.FRIENDLY_SMALL_WORKER,
#    FRIENDLY_MEDIUM_WORKER: Description.COMMAND_LABELS.FRIENDLY_MEDIUM_WORKER,
#    FRIENDLY_LARGE_WORKER: Description.COMMAND_LABELS.FRIENDLY_LARGE_WORKER,
#
#    SMALL_ENEMY: Description.COMMAND_LABELS.SMALL_ENEMY,
#    LARGE_ENEMY: Description.COMMAND_LABELS.LARGE_ENEMY,
#
...
#
#    FRIENDLY_SMALL_WORKER: Description.COMMAND_DESCRIPTIONS.FRIENDLY_SMALL_WORKER,
#    FRIENDLY_MEDIUM_WORKER: Description.COMMAND_DESCRIPTIONS.FRIENDLY_MEDIUM_WORKER,
#    FRIENDLY_LARGE_WORKER: Description.COMMAND_DESCRIPTIONS.FRIENDLY_LARGE_WORKER,
#
...
const TEXTURES := {
    ...
    FRIENDLY_SMALL_WORKER: preload("res://assets/images/gui/overlay_buttons/destroy_overlay_button.png"),
    FRIENDLY_MEDIUM_WORKER: preload("res://assets/images/gui/overlay_buttons/destroy_overlay_button.png"),
    FRIENDLY_LARGE_WORKER: preload("res://assets/images/gui/overlay_buttons/destroy_overlay_button.png"),
...
static func get_string(type: int) -> String:
    match type:
        ...
        FRIENDLY_SMALL_WORKER:
            return "FRIENDLY_SMALL_WORKER"
        FRIENDLY_MEDIUM_WORKER:
            return "FRIENDLY_MEDIUM_WORKER"
        FRIENDLY_LARGE_WORKER:
            return "FRIENDLY_LARGE_WORKER"
